"""Settings panel for New Relic Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__new_relic_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=new_relic_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_new_relic"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("New Relic Settings & Accounts", level=2),
